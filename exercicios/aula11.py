"""
 ...
 As listas internas contem números entre 1 a 10 e eles podem ser duplicados

    Exercício

 Crie uma função que encontra o primeiro o primeiro duplicado considerando o segundo
  número como a duplicação. Retorne a duplicação considerada.
      Requisitos:
         A ordem do número duplicado é considerada a partir da segunda
         ocorrência do númer, ou seja, o número duplicado em si.
         Exemplo:
